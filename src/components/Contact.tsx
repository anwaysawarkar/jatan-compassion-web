        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="animate-slide-in opacity-0" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600">info@jatan.org</p>
              </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-jatan-orange hover:bg-jatan-yellow text-white p-2 rounded-full transition-colors">
          ...
          <div className="animate-slide-in opacity-0" style={{ animationDelay: '0.4s' }}>
            ...
            <form className="space-y-4">
              ...
              <Button className="bg-jatan-orange hover:bg-jatan-yellow text-white">Send Message</Button>
            </form>
          </div>
        </div>
      </div>
